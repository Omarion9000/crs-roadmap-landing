...
function getSystemPrompt() {
  return [
    ...
    "Use impact_summary as a concise federal baseline line, for example 'Federal baseline: FSW appears open, CEC remains future-facing, FST needs review.'",
    "Use reason to explain what you would prioritize and why that order fits the user's eligibility situation.",
